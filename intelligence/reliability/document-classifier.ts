...
function detectTaskType(
  ...
  if (
    kind === "report" &&
    /business requirements document|functional requirements|moscow priority/.test(lower) &&
    /use case diagram|data flow diagram|activity diagram|class diagram/.test(lower)
  ) {
    return "business_requirements_analysis";
  }
